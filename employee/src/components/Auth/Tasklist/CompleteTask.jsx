  ...
  return (
    <div className="w-full sm:w-[320px] p-5 bg-green-600 text-white rounded-xl shadow-md flex-shrink-0">
      ...
      <div className="flex justify-between mt-4 gap-3">
        <button className="flex-1 bg-white/10 hover:bg-white/20 transition-colors duration-150 py-2 px-3 text-sm rounded-md">
          Completed
        </button>
        <button className="flex-1 bg-red-500 hover:bg-red-600 transition-colors duration-150 py-2 px-3 text-sm rounded-md">
          Mark as failed
        </button>
      </div>
    </div>
